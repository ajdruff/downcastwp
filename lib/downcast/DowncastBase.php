...
* Add SITE Embed Tags
*/
$this->CONFIG[ 'SITE' ][ 'EMBED_TAGS' ] = (isset( $this->CONFIG[ 'SITE' ][ 'EMBED_TAGS' ] )) ? $this->CONFIG[ 'SITE' ][ 'EMBED_TAGS' ] : array();
...
if ( isset( $this->CONFIG[ 'TEMPLATE' ][ 'CONTENT_TAGS' ] ) ) {
...
*/
if ( isset( $this->CONFIG[ 'TEMPLATE' ][ 'EMBED_TAGS' ] ) ) {
...
$this->addCssAndJs(); //define CSS and Javascript Template Tags
...
$tags = (isset( $this->_config_properties[ 'CONTENT_TAGS' ] )) ? $this->_config_properties[ 'CONTENT_TAGS' ] : array();
$tags[ $tag_name ] = $value;
...
* @return void
*/
protected function _addFileEmbedTag( $tag_name, $file_path ) {
//only add template tags if we are not parsing content or we'll end up in a loop
...
$tags = (isset( $this->_config_properties[ 'EMBED_TAGS' ] )) ? $this->_config_properties[ 'EMBED_TAGS' ] : array();
/*
...
protected function _addPlugin( $plugin_name ) {
...
include_once ($this->file_joinPaths( $this->getRootDirectory(), "lib/bootdown/bootdown.php" )); //add the bootdown library here  so we don't run into problems with a globally declared Markdown function with plugins.
...
*/
protected function _addMissingSiteConfig( $array_config ) {
...
* @return void
*/
protected function _loadSiteConfigFile() {
...
* @return void
*/
protected function _loadTemplateConfigFile() {
/*
*  Add Template Configuration
*/
...
$plugin_file_path = $this->file_joinPaths( $this->getRootDirectory(), "plugins/", $plugin_unique_id, $plugin_unique_id . ".php" );
$plugin_configuration_file = $this->file_joinPaths( $this->getRootDirectory(), "plugins/", $plugin_unique_id, "config.json" );
...
$error_details = "The class, parent directory name, and/or plugin class file name do not match, or you are missing the plugin class file or configuration file. Please see DownCast Documentation for more information";
...
* @return void
*/
protected function addEmbedTagsOLD() {
...
* @return void
*/
protected function _getSkinCssAndJsOLD12_9_2014() {
/*
* Initialize
*/
...
* @return void
*/
protected function _getResourceTagContent( $extensions, $extensions_relative_path_prefix = null ) {
/*
* Initialize
*/
...
* @return void
*/
protected function _getPluginCssAndJsOLD2() {
/*
* Initialize
*/
$css = '';
...
echo '<br>this is a fake callback';
...
* Must be public to support WordPress extension
* @param none
* @return void
*/
...
* @return void
*/
protected function _addScriptVars( $tag_name, $content ) {
...
*/
protected function _implodeResourceArray( $resource_relative_path, $resource_array, $css = true, $inline = false ) {
//initialize
$string = '';
...
* @return string A concatenated string containing the resources either as inline <style></style> and <script></script> tags or linked resources
*/
protected function _implodeResourceArray2( $resource_relative_path, $resource_array, $css = true ) {
//initialize
$string = '';
