...
$out =  implode('', file($this->getRootDirectory().'/plugins/FindMyHost/libs/phpWhois/example.html'));
...
if (isSet($_GET['query']))
	...
	include_once($this->getRootDirectory().'/plugins/FindMyHost/libs/phpWhois/src/whois.main.php');
	include_once($this->getRootDirectory().'/plugins/FindMyHost/libs/phpWhois/src/whois.utils.php');
